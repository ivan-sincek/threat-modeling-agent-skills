...
6. Deduplicate the identified threats originating from the same weakness, retaining only the threat with the highest CVSS score.
...
| **Created With** | Use verbatim: `PASTA Threat Modeling Framework 4.0`. |
...
- Use the verbatim system component identifier and name for the name of the attack tree.
